        ...
        <div class="table-container">
          <table class="reports-table">
            ...
            <tbody>
              ...
              <tr v-if="!quarterlyData.length">
                <td colspan="5" style="text-align:center; color:#64748b;">{{ t('common.noData') }}</td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <tbody>
              <tr v-for="(month, index) in monthlyData" :key="month.month">
                ...
                <td>
                  ...
                  <span v-else class="first-month" :title="t('reports.firstMonth')">—</span>
                </td>
                <td>
                  <span v-if="index > 0" :class="getChangeClass(month.revenue, monthlyData[index - 1].revenue)">
...
export default {
  ...
  setup() {
    ...
    const getBarHeight = (revenue) => {
      const max = Math.max(...monthlyData.value.map(m => m.revenue), 1)
